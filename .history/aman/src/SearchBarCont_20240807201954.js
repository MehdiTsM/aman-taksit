            ...
            <div className="overflow-y-auto max-h-80 mt-4">
              <div className="flex flex-col">
                ...
                {products.map(product => (
                  <div key={product.ID} className="flex items-start border rounded-lg shadow-lg bg-customWhite p-4 mb-2 hover:border-customGreen hover:border-2 transition-all duration-300">
                    <img 
