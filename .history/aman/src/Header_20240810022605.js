  ...
  return (
    <header className="bg-customDarkGreen p-4 md:p-6">
      <div className="flex justify-between items-center">
        ...
        <nav className="flex space-x-4 md:space-x-8 align-c">
          <NavLink 
            to="/" 
            className="text-xl text-customWhite md:text-2xl relative pb-1 hover:text-customOrange transition-colors duration-300 hover:border-b-2 border-customOrange"
