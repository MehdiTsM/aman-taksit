  ...
  return (
    <div className='flex items-center'>
      ...
      <div className='flex p-5 items-center'>
        ...
        <input
          type="checkbox"
          checked={selectedFilter === 'television'}
          onChange={() => onFilterChange('television')}
        />
      </div>
      <div className='flex p-5 items-center'>
        <h2 className='pr-4'>Cuisiniéres</h2>
        <input
          type="checkbox"
          checked={selectedFilter === 'cuisiniéres'}
          onChange={() => onFilterChange('cuisiniere')}
        />
      </div>
    </div>
  );
