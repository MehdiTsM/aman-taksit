...
function Motocycle() {
  ...
  useEffect(() => {
    fetch('http://localhost:8081/products/motocycle')
  ...
  return (
    <div className="container mx-auto p-4 mb-20 animate-fadeInUp">
      <h1 className="text-3xl md:text-4xl font-semibold text-customDarkGreen mb-8 mt-8">Motocycle :</h1>
