              ...
              <div className='flex flex-col'>
                ...
                <div className='flex p-2 items-center'>
                  ...
                  <input
                    ...
                    onChange={() => handleFilterChange('fours')}
                  />
                </div>
                <div className='flex p-2 items-center'>
                  ...
                  <input
                    ...
                    onChange={() => handleFilterChange('refrigerateurs')}
                  />
                </div>
                <div className='flex p-2 items-center'>
                  ...
                  <input
                    ...
                    onChange={() => handleFilterChange('lave-linge')}
                  />
                </div>
                <div className='flex p-2 items-center'>
                  ...
                  <input
                    ...
                    onChange={() => handleFilterChange('climatiseurs')}
                  />
                </div>
                <div className='flex p-2 items-center'>
                  ...
                  <input
                    ...
                    onChange={() => handleFilterChange('lave-vaisselle')}
                  />
                </div>
                <div className='flex p-2 items-center'>
                  ...
                  <input
                    ...
                    onChange={() => handleFilterChange('micro-ondes')}
                  />
                </div>
                <div className='flex p-2 items-center'>
                  ...
                  <input
                    ...
                    onChange={() => handleFilterChange('plaques-de-cuisson')}
                  />
                </div>
                <div className='flex p-2 items-center'>
                  ...
                  <input
                    ...
                    onChange={() => handleFilterChange('hottes')}
                  />
                </div>
                <div className='flex p-2 items-center'>
                  ...
                  <input
                    ...
                    onChange={() => handleFilterChange('petit-electromenager')}
                  />
                </div>
                <div className='flex p-2 items-center'>
                  ...
                  <input
                    ...
                    onChange={() => handleFilterChange('chauffages')}
                  />
                </div>
