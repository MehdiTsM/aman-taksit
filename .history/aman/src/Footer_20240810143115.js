...
const Footer = () => {
  return (
    <footer className="bg-gray-900 text-white py-6 animate-fadeInUp">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:items-start items-center space-y-8 md:flex-row md:space-y-0 md:space-x-8 justify-around">
          ...
          <div className="w-full md:w-1/3 flex flex-col items-center text-center">
            ...
            <div className="flex space-x-4 justify-center items-center">
              <a className="text-2xl font-bold transition hover:text-customOrange"><FacebookIcon /></a>
              <a className="text-2xl font-bold transition hover:text-customOrange"><FontAwesomeIcon icon={faTiktok} /></a>
              <a className="text-2xl font-bold transition hover:text-customOrange"><InstagramIcon /></a>
            </div>
          </div>
