...
const categories = [
  ...
  { name: 'Smart Phone', description: 'Téléphones portables et accessoires' },
  { name: 'Informatique', description: 'Ordinateurs et équipements informatiques' },
  { name: 'Motocycle', description: 'Motocycle et accessoires pour les passionnés de deux roues' },
  { name: 'Meubles', description: 'Meubles et articles de décoration pour la maison' },
