        ...
        <nav className="w-full md:w-auto">
          <ul className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-8 items-center">
            <li>
              ...
              <a className="relative pb-5 text-xl font-medium transition hover:text-customOrange hover:border-b-2-none border-customOrange md:border-customOrange"> Accueil
                </a>
              </NavLink>
            </li>
            <li>
              <NavLink to="/a-propos" className={({ isActive }) => (isActive ? 'text-customOrange' : '')}>
                <a className="relative text-xl font-medium transition hover:text-customOrange pb-5 border-customOrange hover:border-b-2 md:hover:border-none">
                  À propos
                </a>
              </NavLink>
            </li>
