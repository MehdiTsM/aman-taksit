...
function SearchBarCont() {
  ...
  const handleSearch = async (query) => {
    if (query.trim() === '') {
      ...
      setSearchPerformed(false); // Clear search performed flag
      return;
    }
    try {
  ...
  useEffect(() => {
    const handleClickOutside = (event) => {
      console.log('Click detected'); // Debug statement
      console.log('Event target:', event.target); // Debug statement
      console.log('Categories Ref:', categoriesRef.current); // Debug statement
      console.log('Button Ref:', buttonRef.current); // Debug statement
      console.log('Results Ref:', resultsRef.current); // Debug statement
      ...
      if (
        ...
        console.log('Click outside detected'); // Debug statement
    ...
    return () => {
      console.log('Removing event listener'); // Debug statement
