        ...
        <nav className="w-full md:w-auto">
          <ul className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-8 items-center">
            <li>
              ...
              <a className="relative pb-5 text-xl font-medium transition hover:text-customOrange hover:md:border-b-2 md:border-customOrange sm:hover:border-none">                  Accueil
                </a>
              </NavLink>
            </li>
            <li>
