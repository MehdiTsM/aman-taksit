    ...
    <div className="mt-10 bg-customOrange p-2">
      <Container>
        <div className="flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-4">
          <div
            ref={buttonRef}
            className="relative flex-shrink-0 flex items-center bg-white text-customGreen border-2 rounded-xl p-2 cursor-pointer transition-all duration-300 ease-in-out hover:bg-gray-100 hover:text-customGreen"
          ...
          >
            ...
            {showCategories && (
              <div
                ref={categoriesRef}
                className="absolute left-0 top-full mt-2 w-48 border-2 rounded-xl p-4 bg-white shadow-lg z-10 transition-transform duration-300 ease-in-out transform scale-100"
              >
                <h2 className="text-lg text-customDarkGreen font-semibold">Catégories</h2>
                <br />
                <hr />
                <br />
                <ul className="text-customOrange text-lg font-medium flex flex-col space-y-2">
