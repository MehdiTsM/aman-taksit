    ...
    <header className="bg-customDarkGreen md:p-6 h-20 " >
      <div className="flex justify-around items-center">
        ...
        <nav className="flex space-x-4 md:space-x-8 items-center">
          <NavLink 
            to="/" 
            className="text-xl text-customWhite md:text-2xl relative border-b-2 border- hover:text-customOrange transition-colors duration-300 hover:border-b-2 border-customOrange  pb-6"
