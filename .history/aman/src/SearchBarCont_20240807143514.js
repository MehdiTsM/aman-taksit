...
function SearchBarCont() {
  ...
  useEffect(() => {
    fetch('http://localhost:8081/products') // Endpoint for all products
  ...
  return (
    <div>
      ...
      <div className="container mx-auto p-4">
        <h1 className="text-3xl md:text-4xl font-semibold text-customDarkGreen mb-8 mt-8">Products :</h1>
