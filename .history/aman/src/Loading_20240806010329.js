  ...
  return (
    <div className="fixed inset-0 flex flex-col items-center justify-center bg-gray-300 bg-opacity-50 z-50">
      ...
      <div className="relative flex items-center justify-center">
        ...
        <div className="absolute animate-spin rounded-full h-24 w-24 border-t-4 border-b-4 border-customDarkGreen opacity-50"></div>
      </div>
      {/* Loading Text */}
      <p className="mt-4 text-customWhite text-4xl font-semibold">...</p>
    </div>
  );
};
