...
app.get('/products/electromenager', (req, res) => {
    const filter = req.query.filter;
  
    let query = 'SELECT * FROM products WHERE category = "Electromenager"';
    if (filter && filter !== 'Tout') {
      query += ` AND type = '${filter}'`; // Adjust column name and filter value as needed
    }
